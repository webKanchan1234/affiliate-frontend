...
const Card = ({ image, title, price, url }) => {
  return (
      ...
      <Link to={url} className="group rounded-xl border border-gray-200 shadow-lg p-3 transition-transform transform hover:scale-105 hover:shadow-2xl bg-gradient-to-b from-white to-gray-50 flex flex-col cursor-pointer m-2"
